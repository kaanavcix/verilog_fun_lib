...
HD_PWD='D:/fpga/7_segment_arch/7_segment_arch.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bcd_incrementor.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bcd_incrementor.tcl
